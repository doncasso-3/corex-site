  ...
  return (
    <div style={{
      ...
      <div style={{ position:"absolute", top:28, left:32, zIndex:10 }}>
        <div style={{ fontFamily:"'IBM Plex Mono', monospace", color:"rgba(255,255,255,0.28)", fontSize:"8px", letterSpacing:"0.44em" }}>CORE X LAB</div>
        <div style={{ fontFamily:"'Bebas Neue', sans-serif", color:"#fff", fontSize:"22px", letterSpacing:"0.24em", marginTop:"6px" }}>SYSTEM MAP</div>
      </div>
      ...
      <div style={{ position:"absolute", top:28, right:32, zIndex:20, fontFamily:"'IBM Plex Mono', monospace", display:"flex", alignItems:"center", gap:"18px" }}>
        <div style={{ display:"flex", alignItems:"center", gap:"10px" }}>
          <div style={{ color:ACCENT, fontSize:"8px", letterSpacing:"0.3em" }}>● ONLINE</div>
          <div style={{ color:"rgba(255,255,255,0.18)", fontSize:"9px" }}>{clock}</div>
        </div>
        ...
        <div style={{ padding:"72px 28px 28px", overflowY:"auto", maxHeight:"100vh" }}>
          {NODES.map((n, i) => (
            ...
            >
              ...
              <div style={{ flex:1 }}>
                <div style={{ color: n.primer ? ACCENT : "#fff", fontSize:"10px", letterSpacing:"0.18em" }}>{n.label}</div>
                <div style={{ color:"rgba(255,255,255,0.25)", fontSize:"7px", letterSpacing:"0.12em", marginTop:"2px" }}>{n.sub}</div>
              </div>
              {n.primer && <div style={{ color:ACCENT, fontSize:"7px", letterSpacing:"0.18em" }}>START</div>}
            </div>
          ))}
        </div>
      </div>
      ...
      <div style={{ position:"absolute", bottom:28, left:32, zIndex:10 }}>
        <div style={{ fontFamily:"'Bebas Neue', sans-serif", color:"#fff", fontSize:"34px", letterSpacing:"0.1em", lineHeight:1.0 }}>
          OPERATE<br/>BY DESIGN.
        </div>
        <div style={{ fontFamily:"'IBM Plex Mono', monospace", color:"rgba(255,255,255,0.2)", fontSize:"8px", letterSpacing:"0.4em", marginTop:"10px" }}>
          REJECT DEFAULT
        </div>
      </div>
      ...
      <div style={{ position:"absolute", bottom:28, right:32, zIndex:10, textAlign:"right", fontFamily:"'IBM Plex Mono', monospace" }}>
        <div style={{ color:"rgba(255,255,255,0.18)", fontSize:"7px", letterSpacing:"0.34em", marginBottom:"10px" }}>START HERE</div>
        <div style={{ display:"flex", gap:"8px", justifyContent:"flex-end" }}>
          {NODES.filter(n => n.primer).map(n => (
            <div key={n.id} onClick={() => navigate(n.id)} style={{
              color:ACCENT, fontSize:"8px", letterSpacing:"0.2em",
